      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-3 gap-8">
        <div className="col-span-3 md:col-span-1">
          ...
          <input
            ...
            className={`w-full p-3 border ${errors.name ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none`}
          />
        ...
        <div className="col-span-3 md:col-span-1">
          ...
          <input
            ...
            className={`w-full p-3 border ${errors.mobile ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none`}
          />
        ...
        <div className="col-span-3 md:col-span-1">
          ...
          <input
            ...
            className={`w-full p-3 border ${errors.email ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none`}
          />
        ...
        <div className="col-span-3 md:col-span-1">
          ...
          <select
            ...
            className={`w-full p-3 border ${errors.role ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none`}
          >
